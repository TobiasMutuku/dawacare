...
class SupplierForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['krapin'].widget.attrs.update({'class': 'textinput form-control', 'maxlength': '15', 'pattern' : '[0-9]{15}', 'title' : 'KRAPIN Format Required'})
    class Meta:
        model = Supplier
        fields = ['name', 'phone', 'address', 'krapin', 'email']
        widgets = {
...
class SaleForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['email'].widget.attrs.update({'class': 'textinput form-control'})
        # self.fields['krapin'].widget.attrs.update({'class': 'textinput form-control', 'maxlength': '15', 'pattern' : '[A-Z0-9]{15}', 'title' : 'GSTIN Format Required'})
    class Meta:
        model = SaleBill
