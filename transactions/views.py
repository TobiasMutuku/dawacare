...
# # define a port for the email server
# fana_smtp = smtplib.SMTP('smtp.gmail.com', 587)

# # send a hello messageto the server to start communication
# fana_smtp.ehlo()

# # start tlsconnection
# fana_smtp.starttls()

# fana_smtp.login(user=settings.USER, password=settings.PASSWD)
...
class SupplierListView(ListView):
    ...
    queryset = Supplier.objects.all().filter(is_deleted=False)
    paginate_by = 10
